...
export function MovieList({ movies: initialMovies }: MovieListProps) {
  const [allMovies, setAllMovies] = React.useState<Movie[]>(initialMovies);
  const [filteredMovies, setFilteredMovies] = React.useState<Movie[]>(initialMovies);
